  ...
  return (
    <div style={styles.container}>
      ...
      <main>
        ...
        <section style={styles.section}>
          <h2 style={styles.sectionTitle}>Principle Phases of Startup</h2>
          <ul style={styles.list}>
            <li><strong>Idea Validation:</strong> Validate the product concept through market research and feedback.</li>
            <li><strong>Product Development:</strong> Develop the MVP and iterate based on user feedback.</li>
            <li><strong>Market Entry:</strong> Launch the product, acquire customers, and optimize based on feedback.</li>
            <li><strong>Revenue Model & Growth:</strong> Focus on monetization, scaling, and increasing customer acquisition.</li>
            <li><strong>Funding & Scaling:</strong> Seek funding to scale operations, expand the team, and grow globally.</li>
          </ul>
        </section>
      </main>
